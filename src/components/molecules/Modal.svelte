...
<dialog class:hide={showModal == false} class:show={showModal == true}>
	<div class="drop-area ">
		...
		<a
			target="_blank"
			href="https://teams.microsoft.com/_#/files/General?threadId=19%3A96955f08827f4d52a19e5ae5e410f968%40thread.skype&ctx=channel&context=Validador&rootfolder=%252Fsites%252FCTO-TransformacinAGILEyDevops%252FShared%2520Documents%252FGeneral%252FAgile%2526EE%2520Academy%25202020%252FEtiquetado%2520Roles%252FValidador%2520Web%252FValidador">Carpeta
